...
class Engine:
    ...
    def __init__(self, fen):
        ...
        self.square_table = {'P': (0, 0, 0, 0, 0, 0, 0, 0,
                                        78, 83, 86, 73, 102, 82, 85, 90,
                                        7, 29, 21, 44, 40, 31, 44, 7,
                                        -17, 16, -2, 15, 14, 0, 15, -13,
                                        -26, 3, 10, 9, 6, 1, 0, -23,
...
if __name__ == "__main__":
    ...
    print("Pre eval = " + str(test2.position_eval()))
    for move in test2.board.legal_moves:
        test2.board.push(move)
        print(str(move) + ": " + str(test2.position_eval()))
        test2.board.pop()
    # test.random_move()
    # test.position_eval()
